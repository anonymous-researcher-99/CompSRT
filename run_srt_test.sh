...
# Run Python
exec python basicsr/test.py -opt options/test/test_srtquant_x4.yml "$@" \
          --force_yml bit=2 name=test_srtquant_x4_bit4 \
          path:pretrain_network_Q=experiments/train_srtquant_x4_bit4_srtquant_30percentactprune_time/models/net_Q_100.pth 
